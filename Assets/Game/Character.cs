...
public class Character : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (//移动条件)
        {
            animThis.SetBool("move", true);
        }
        else
        {
            animThis.SetBool("move", false);
        }

        //设置切换攻击状态
        if ()
        {
            animThis.SetTrigger("Attack");
        }

        //设置切换受击状态
        if ()
        {
            animThis.SetTrigger("Defence");
        }

        //设置切换死亡状态
        if ()
        {
            animThis.SetBool("Death", true);
        }

        else 
        {
            animThis.SetBool("Death", false);
        }
